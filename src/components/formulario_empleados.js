...
function FormularioEmpleados({ editar_empleados, onSaveComplete }) {
  ...
  const handleSubmit = (e) => {
    ...
    const nuevo_empleado = { RUT_empleado, id_cargo, NIT_hotel, nombre_empleado, telefono_empleado, direccion_empleado, correo_electronico, fecha_nacimiento, EPS, salario, tipo_contrato };
    ...
    const url = editar_empleados
      ? `http://localhost:3000/api/empleado/${editar_empleados._id}` // Actualizar
      : "http://localhost:3000/api/empleado"; // Crear nuevo
